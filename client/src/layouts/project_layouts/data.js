...
exports.SelfRefData = [
    ...
    { TaskID: 7, TaskName: 'Đâu mà ghi hoài', StartDate: new Date('04/02/2024'), Duration: 3, Progress: 50, ParentId: 5},
    { TaskID: 8, TaskName: 'hihi', StartDate: new Date('04/02/2024'), Duration: 4, Progress: 50, ParentId: 1},
    { TaskID: 9, TaskName: 'đồ ngốc', StartDate: new Date('04/02/2024'), Duration: 4, Progress: 50, ParentId: 1},
];